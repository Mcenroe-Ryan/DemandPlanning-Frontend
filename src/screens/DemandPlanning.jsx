...
//         </IconButton>
//         <Box position="relative" width={24} height={20}>
//           <ChatBubbleOutline
...
//     </Box>
//   ) : activeTab === 2 ? (
//     <Box sx={{ width: "100%", minHeight: 0, bgcolor: "#e9f0f7", p: 0, m: 0, display: "flex", flexDirection: "column" }}>
  ...
  return (
    <Box>
      ...
      >
        ...
        {/* --- Chat Icon Button (open sidebar) --- */}
        {/* <Box position="relative" width={24} height={20} onClick={handleOpenActivities} sx={{ cursor: "pointer" }}>
          <ChatBubbleOutline
            sx={{ position: "absolute", width: 20, height: 20 }}
          />
          <img
