...
// // Red triangle for consensus cells
// const RedTriangleIcon = ({ visible = true }) => {
//   if (!visible) return null;
//   return (
//     <Box
...
//       REVENUE_LABEL,
//     ];
//   }, [selectedCountry]); // Only depend on selectedCountry, not derived REVENUE_LABEL
...
//   // Add ref to track last request params to prevent duplicate calls
...
//   // Keymap needs both Revenue row label options
//   const keyMap = {
//     Actual: "actual_units",
//     "Baseline Forecast": "baseline_forecast",
//     "ML Forecast": "ml_forecast",
...
//   // Optimized fetch function with duplicate request prevention
//   const fetchForecastData = useCallback(() => {
//     // Create a request signature to avoid duplicate calls
...
//       startDate, endDate, selectedCountry, selectedSKUs, modelName
//     });
...
//   // Debounce the fetch function to prevent rapid calls
//   const debouncedFetch = useDebounce(fetchForecastData, 300);
...
//   // Use the debounced fetch in useEffect
//   useEffect(() => {
//     debouncedFetch();
//   }, [debouncedFetch]);
